...
def get_match_details(match_id):
    ...
    try:
        ...
        if estado == "Programado":
            ...
            return json.dumps({"error": "Partido en curso, pronto estarán disponibles las estadísticas."}, ensure_ascii=False)
        elif estado == "Pospuesto":
            return json.dumps({"error": "Partido Pospuesto, no se pueden obtener detalles."}, ensure_ascii=False)
        elif estado == "Cancelado":
            return json.dumps({"error": "Partido Cancelado, no se pueden obtener detalles."}, ensure_ascii=False)
